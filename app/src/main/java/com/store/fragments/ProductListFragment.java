...
public class ProductListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ListView listView = (ListView) view.findViewById(R.id.commonListView);
        ArrayAdapter adapter = new ProductListAdapter(getActivity(),R.layout.product_list,productPOJOs);
